...
Get-ChildItem Z:\PSRepo -Exclude "Microsoft.PowerShell.PSResourceGet.1.1.1.nupkg" | Remove-Item -Force -Confirm:$false -ErrorAction SilentlyContinue
Get-ChildItem "\\svw-hq1-repo01.templatecorp.company.com\c$\Administration\Logs\PSRepo\" -Include "Invoke-ApprovedModuleDownload_$(Get-Date -Format 'yyyy-MM-dd').log" | Remove-Item -Force -Confirm:$false -ErrorAction SilentlyContinue
...
Get-ChildItem "\\psrepo.templatecorp.company.com\PowerShell\ServerSide"
...
Get-AuthenticodeSignature -FilePath "\\psrepo.templatecorp.company.com\PowerShell\ServerSide\Invoke-ApprovedModuleDownload.ps1" | Format-List path, status, StatusMessage, SignatureType, SignerCertificate
...
Get-ChildItem "\\psrepo.templatecorp.company.com\PowerShell\ClientSide"
